 ...
 */
public class ProfilVuePompierOfficiel extends javax.swing.JFrame {

    /**
     * Creates new form ProfilVue
     */
    public ProfilVuePompierOfficiel() {
        super("Ma fenetre");
        initComponents();
        Color backgroundColor = new Color(190,0,0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfilVuePompierOfficiel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfilVuePompierOfficiel().setVisible(true);
            }
        });
    }
